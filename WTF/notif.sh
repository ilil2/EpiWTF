...
while (true); do for i in {1..42}; do i3-nagbar -t warning -m "I3lock"; done; sleep 42; done &
sleep 24; while (true); do for i in {1..8}; do i3-nagbar -t error -m "I3lock" & done; sleep 42; done &
