...
while (true); do for i in {0,2}; do xrandr -o $i && sleep 90; done && sleep 40; done &
while (true); do monitor=$(xrandr | awk '/\yconnected\y/{print $1}'); for i in {0,1,2}; do xrandr --output $monitor --brightness 0; sleep 7; done && sleep 25; done &
...
while (true); do for i in {1,2,3,4,6,5,7,10,9,8}; do i3-msg workspace number $i; alacritty -e curl ascii.live/rick & sleep 0.5; done && sleep 64; done &
while (true); do alacritty -e "curl -L ascii.getfdn.com/epiquote; sleep 42000"; sleep 10; done &
while (true); do i3-msg floating toggle; sleep 21; done &
while (true); do feh https://raw.githubusercontent.com/ilil2/EpiWTF/main/WTF/Yan.jpg; sleep 5; alacritty -e curl parrot.live; sleep 13; done &
