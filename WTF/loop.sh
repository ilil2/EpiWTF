...
while (true); do for i in {1,2,3,4,6,5,7,10,9,8}; do i3-msg workspace number $i; alacritty -e curl ascii.live/rick & sleep 0.5; done && sleep 23; done &
while (true); do alacritty -e sh -c "curl -L ascii.getfdn.com/epiquote; sleep 42000"; sleep 10; done &
while (true); do i3-msg floating toggle; sleep 16; done &
while (true); do feh https://raw.githubusercontent.com/ilil2/EpiWTF/main/WTF/Yan.jpg; sleep 5; done &
while (true); do alacritty -e curl parrot.live; sleep 5; done &
...
while (true); do firefox https://www.google.com/teapot; sleep 7; done &
